...
def check_hsh_metadata(metadata):
    ...
    metadata_test = {
        ...
        "resource": {
            ...
            "collection": ["COVID-19", "coverCHILD study platform"],
            "contributors": [
                {
                    "affiliations": [
                        {
                            ...
                            "identifiers": [
                                {"identifier": "001w7jn25", "scheme": "ROR"}
                            ],
            ...
            "provenance": {"dataSource": "Manually collected"},
            "titles": [{"language": "EN (English)", "text": "S1 File. Raw data."}],
        },
        "versions": [
            {
